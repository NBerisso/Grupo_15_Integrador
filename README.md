...
Nuestro sitio ofrecera una experiencia al cliente para poder adquirir cafe proveniente de distintas partes del mundo, con variad de sabores e intensidad. Tambien ofrecera distintos tipos de moliendas orientadas a las diferentes maquinas que pueda tener el usuario y asi poder disfrutar de nuestra amplia seleccion de cafes tanto en grano, como para french press, listo para Aeropress, maquina de Espresso o inclusive para tradicional Filtrado Manual.
